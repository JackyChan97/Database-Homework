    ...
    try:
        ...
        with conn.cursor() as cursor:
            ...
            try:
                ...
                print(InputCheck)
                if(InputCheck):
                    cursor.execute(sql, (studentID, courseID, teacherID, chosenYear, score))
                    result = cursor.fetchall()
                    print(result)
            except:
                print('Insertion failed.')
...
def UpdateCourseChoose(studentID, courseID, teacherID, chosenYear, score):
    ...
    try:
        ...
        with conn.cursor() as cursor:
            ...
            sql = """
                          update courseChoose
                          set teacherID = %s, chosenYear = %s, score = %s
                          where studentID = %s and courseID = %s 
                          """
            try:
                ...
                print(InputCheck)
                if(InputCheck):
                    cursor.execute(sql, (teacherID, chosenYear, score, studentID, courseID))
                    result = cursor.fetchall()
                    print(result)
            except:
                print('Update failed.')
